...
const Contact = () => {
  ...
  return (
    <div className='pt-10 border-t'>
      ...
      <h1 className='text-2xl font-bold mb-6 text-[#504C41]'>Let's Connect</h1>
      ...
      <div className='mb-12'>
        ...
        <div className='border border-gray-300 rounded-lg p-6 mb-8 bg-gray-50'>
          ...
          <div className='mb-4'>
            ...
            <p className='text-gray-700'>@DiceTrails (Instagram/X/Facebook)</p>
          </div>
      ...
      <div className='mb-12'>
        ...
        {!user ? (
          <div className='bg-gray-100 rounded-lg p-8 text-center'>
            ...
            <Link to='/login' className='bg-[#D0A823] text-black font-semibold px-6 py-2 rounded hover:bg-[#b8921d] transition-colors'>
              Login Here
            </Link>
          </div>
        ) : (
