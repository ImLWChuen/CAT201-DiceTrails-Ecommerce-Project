                    ...
                    getFilteredOrders().map((item, index) => (
                        <div key={index} className='py-4 border-t border-b text-[#504c41] flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
                            ...
                            <div className='md:w-1/2 flex justify-between'>
                                <div className='flex items-center gap-2'>
                                    <p className='min-w-2 h-2 rounded-full bg-[#D0A823]'></p>
                                ...
                                <div className='flex items-center gap-2'>
                                    ...
                                    {item.status === 'Completed' && !item.reviewed && (
                                        <button
                                            onClick={() => navigate(`/add-review/${item.orderId}/${item._id}`)}
                                            className='border px-4 py-2 text-sm font-medium rounded-sm bg-[#504c41] text-white hover:bg-[#D0A823] transition-colors'
                                        >
                                            Review Product
                                        </button>
                                    )}
