                    ...
                    getFilteredOrders().map((item, index) => (
                        <div key={index} className='py-4 border-t border-b text-[#504c41] flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
                            ...
                            <div className='flex items-start gap-6 text-sm'>
                                ...
                                <div>
                                    ...
                                    <div className='flex items-center gap-3 mt-2 text-base text-[#504c41]'>
                                        <p className='text-[#D0A823]'>{formatPrice(item.price)}</p>
                            ...
                            <div className='md:w-1/2 flex justify-between items-center'>
                                <div className='flex items-center gap-2'>
                                    <p className={`min-w-2 h-2 rounded-full ${item.status === 'Ready to ship' ? 'bg-green-500' : item.status === 'Cancelled' ? 'bg-red-500' : 'bg-gray-400'}`}></p>
                                ...
                                <div className='flex gap-2'>
                                    {item.status === 'Ready to ship' && (
                                        <button
                                            ...
                                            className='border border-red-500 text-red-500 px-4 py-2 text-sm font-medium rounded-sm hover:bg-red-50 transition-all duration-300'
                                        >
                                            Cancel Order
                                        </button>
                                    )}
