            ...
            {activeTab === 'delivery' && (
              <div className='animate-fadeIn'>
                ...
                <AccordionItem 
                   ...
                   answer="We offer standard delivery within 3-5 business days and express delivery within 1-2 business days. All orders are processed within 24 hours during business days."
                 />
                 <AccordionItem 
                   question="What are the shipping fees?" 
                   answer="Shipping costs are calculated based on your location and delivery speed. Free shipping is available for orders over RM100."
                 />
                 <AccordionItem 
                   question="Do you deliver internationally?" 
                   answer="Currently, we deliver within Malaysia. International shipping may be available upon request. Please contact us for inquiries."
                 />
                 <AccordionItem 
