                      ...
                      {formData.image.map((img, index) => (
                        <div key={index} className='relative group'>
                          ...
                          <button
                            ...
                            title='Remove image'
                          >
                            <img src={assets.close_new} className='w-3 h-3' alt="remove" />
                          </button>
                        </div>
                      ))}
                    </div>
                ...
                <tr key={product._id} className='border-t hover:bg-gray-50'>
                  ...
                  <td className='px-6 py-4 text-center'>
                    ...
                    >
                      {product.isVisible ? (
                        <>
                          <img src={assets.visible_icon} className='w-4 h-4' alt="visible" />
                          Visible
                        </>
                      ) : (
                        <>
                          <img src={assets.visible_off_icon} className='w-4 h-4' alt="hidden" />
                          Hidden
                        </>
                      )}
                    </button>
                  ...
                  <td className='px-6 py-4'>
                    <div className='flex gap-2 justify-center'>
                      ...
                      >
                        <img src={assets.edit_icon} className='w-4 h-4' alt="edit" />
                        Edit
                      </button>
                      <button
